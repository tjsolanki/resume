                    ...
                    <div className='text-center p-12'>
                        ...
                        <div className="flex justify-center mt-5 mb-4 ">
                            ...
                            <div className="w-0/12 ms-5">
                                <div className="rounded-full ...  w-12 h-12 hover:shadow-pink-500 shadow-[5px_2px_40px_1px_rgba(0,0,0,0.56)] ">
                                    <a href='https://twitter.com/TwishaSolanki' className="inline-flex   items-center justify-center w-12 h-12 mr-2 text-pink-500 transition-all duration-300 bg-white rounded-full shadow-md hover:shadow-xl ">
